...
> **⚠️ "PocketNotes를 열 수 없습니다" 경고가 뜨는 경우**
>
> Apple 공증(Notarization)이 없는 앱을 인터넷에서 다운받으면 macOS Gatekeeper가 차단합니다.  
> 아래 두 가지 방법 중 하나로 해제할 수 있습니다. **한 번만 하면 이후엔 정상 실행됩니다.**
>
> **방법 1 — 시스템 설정 (권장)**
> 1. 앱 실행 시도 (경고창이 뜨고 차단됨)
...
> **방법 2 — 터미널**
> ```bash
> xattr -dr com.apple.quarantine /Applications/PocketNotes.app
> ```
